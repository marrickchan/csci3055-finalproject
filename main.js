...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    "^": "",
    main: [function() {
      var t1 = J.get$onInput$x(document.querySelector("#searchField"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(F.main__updateSearch$closure()), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    }, "call$0", "main__main$closure", 0, 0, 1],
    updateSearch: [function(e) {
      document.querySelector("#searchPreview").textContent = H.interceptedTypeCast(J.get$target$x(e), "$isInputElement").value;
    }, "call$1", "main__updateSearch$closure", 2, 0, 13]
  }, 1]];
  setupProgram(dart, 0);
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, v: true}, {func: 1, args: [,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, v: true, args: [W.Event]}];
